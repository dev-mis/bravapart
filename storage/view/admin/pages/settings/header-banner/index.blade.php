    ...
    <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h2 class="subheader-title text-dark font-weight-bold my-1 mr-3">Header Banner</h2>
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ url('admin/settings/header-banner') }}" class="text-muted">Header Banner</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <span class="card-icon"><i class="flaticon2-photograph text-primary"></i></span>
                    <h3 class="card-label">Update Header Banner</h3>
                </div>
            </div>
            <form action="{{ url('admin/settings/header-banner/update') }}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group picture_upload col-md-6">
                            ...
                            <div class="form-group__file">
                                <div class="file-wrapper">
                                    <input type="file" name="image_mobile" class="file-input" accept="image/jpeg, image/png, image/jpg"/>
                                    <div class="file-preview-background">+</div>
                                    @if(!empty($data->imageMobile))
                                        <img src="{{ $data->imageMobile->path }}" style="opacity: 1" width="240px" class="file-preview"/>
                                    @else
                                        <img src="" width="240px" class="file-preview"/>
                                    @endif
                                </div>
