...
class IndexController extends AbstractController
{
    ...
    public function store(RequestInterface $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('identity_card')) {
                ...
                $mediaData = ['content_type' => 'identity_card', 'name' => $file_name, 'file_name' => $file_name, 'path' => 'identity-card/', 'type' => 'image', 'extension' => $file->getExtension(), 'disk' => 'sftp', 'size' => $file->getSize()];
            ...
            if ($request->hasFile('tax_card')) {
                ...
                $mediaData = ['content_type' => 'tax_card', 'name' => $file_name, 'file_name' => $file_name, 'path' => 'tax-card/', 'type' => 'image', 'extension' => $file->getExtension(), 'disk' => 'sftp', 'size' => $file->getSize()];
            ...
            if ($request->hasFile('saving_book')) {
                ...
                $mediaData = ['content_type' => 'saving_book', 'name' => $file_name, 'file_name' => $file_name, 'path' => 'saving-book/', 'type' => 'image', 'extension' => $file->getExtension(), 'disk' => 'sftp', 'size' => $file->getSize()];
            ...
            $response = ['status' => '200', 'success' => true, 'message' => 'Data has been successfully created'];
            DB::commit();
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function firstValidation(RequestInterface $request)
    {
        ...
        if (count($messages) > 0) {
            $response = ['status' => '406', 'success' => false, 'message' => $messages];
        } else {
