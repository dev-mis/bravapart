        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ url('admin/settings/testimonial/create') }}" class="text-muted">Create</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="d-flex flex-column-fluid">
    <div class=" container ">
        <div class="card card-custom">
            ...
            <form action="{{ url('admin/settings/testimonial/create') }}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="occupation" class="form-control form-control-solid" placeholder="Enter occupation"/>
                            </div>
                            <div class="form-group">
                                <label>Review</label>
                                <textarea name="review" rows="3" class="form-control form-control-solid" placeholder="Enter review"></textarea>
                            </div>
                            <div class="form-group">
