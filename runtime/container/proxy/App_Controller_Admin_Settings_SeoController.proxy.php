...
class SeoController extends AbstractController
{
    ...
    public function update(UpdateRequest $request)
    {
        ...
        try {
            ...
            $response = ['status' => '200', 'success' => true, 'message' => 'SEO created successfully', 'redirect' => url('admin/settings/seo')];
            $this->session->set('flash', ['type' => 'success', 'title' => 'Success', 'message' => 'SEO created successfully']);
            DB::commit();
        } catch (Exception $e) {
            DB::rollBack();
