...
final class TraceContext implements SamplingFlags
{
    ...
    public static function createAsRoot(?SamplingFlags $samplingFlags = null, bool $usesTraceId128bits = false) : self
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function (?SamplingFlags $samplingFlags = null, bool $usesTraceId128bits = false) use($__function__, $__method__) {
    ...
    public static function createFromParent(TraceContext $parent) : self
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, self::__getParamsMap(__CLASS__, __FUNCTION__, func_get_args()), function (TraceContext $parent) use($__function__, $__method__) {
            $nextId = Id\generateNextId();
