        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ url('admin/settings/users/edit/'.$data['id']) }}" class="text-muted">Edit</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="d-flex flex-column-fluid">
    <div class=" container ">
        ...
        <div class="card card-custom">
            ...
            <form action="{{ url('admin/settings/users/edit/'.$data['id']) }}" method="POST">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control form-control-solid" placeholder="Enter email" value="{{ $data['email'] }}"/>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="col-form-label">Is Active?</label>
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" {{ $data['is_active'] ? 'checked' : '' }} name="is_active"/>
                                    <span></span>
                                </label>
                            </span>
                        </div>
